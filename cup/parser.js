...
module.exports = new Parser(function analyseEC(parsedUrl) {
  ...
  if (match) {
    ...
    // /core/services/aop-cambridge-core/content/view/A47416428BE9E8F9E03BA624A65831BC/9781316513545AR.pdf/Buried_in_the_Red_Dirt.pdf?event-type=FTLA
    result.mime = 'PDF';
  ...
  } else if ((match = /^\/core\/books\/[a-z0-9-]+\/[a-z0-9-]+\/([a-z0-9-]+)$/i.exec(pathname)) !== null) {
    // /core/books/buried-in-the-red-dirt/making-the-country-pay-for-itself/79F419011553826E2E71774C3A5C8933
    result.rtype = 'BOOK_SECTION';
    result.mime = 'HTML';
    result.unitid = match[1];
