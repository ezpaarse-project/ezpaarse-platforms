...
/**
 * Recognizes the accesses to the platform MIT-Sloan Management Review
...
module.exports = new Parser(function analyseEC(parsedUrl, ec) {
  ...
  if ((match = /^\/article\/(.+)\//i.exec(path)) !== null) {
    ...
    // https://sloanreview.mit.edu:443/article/youre-going-digital-now-what/?og=Winter+2020+Issue+Tiled
  ...
  } else if ((match = /^\/(topic\/.+)\/$/i.exec(path)) !== null) {
