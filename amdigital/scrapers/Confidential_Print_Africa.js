#!/usr/bin/env node
// Write on KBART file the Confidential Print Africa PKB
// Write on stderr the progression
// Usage : ./Confidential_Print_Africa.js
...
pkb.packageName = 'Confidential_Print_Africa'; // default AllTitles
pkb.setKbartName();

var journalsUrl = 'http://galileo.museglobal.ro/~vali/Confidential_Print_Africa.csv';
...
request.get({uri: journalsUrl, encoding: 'binary'}, function (err, resp, body) {
  ...
  csvSource.forEach(function (csvRow) {
    ...
    journalInfo.collection                      = 'Confidential Print: Africa';
