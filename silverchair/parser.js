...
module.exports = new Parser(function analyseEC(parsedUrl, ec) {
  ...
  }  else if ((match = /^\/journals\/([a-z]+)\/[a-z]+\/([0-9]+)$/i.exec(path)) !== null) {
  ...
  } else if ((match = /^\/oup\/[a-z]+\/[a-zA-Z\_]+\/[a-zA-Z]+\/([a-z]+)\/([0-9]+)\/[0-9]+\/([0-9]{2}\.[0-9]{4}\/([a-z]+\/[0-9\.]+))\/[0-9]+\/[0-9\-]*.pdf$/i.exec(path)) !== null) {
