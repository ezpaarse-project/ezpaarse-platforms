...
module.exports = new Parser(function analyseEC(parsedUrl, ec) {
  ...
  if (/^\/search\/doc\/abstract\.url$/i.test(path)) {
  ...
  } else if (/^\/search\/doc\/detailed\.url$/i.test(path)) {
  ...
  } else if (/^\/search\/results\/preview\.url$/i.test(path)) {
  ...
  } else if (/^\/delivery\/download\/submit\.url$/i.test(path)) {
